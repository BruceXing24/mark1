...
class CPG:
    def __init__(self, step_length=0.05, ground_clearance=0.05, ground_penetration=0.01, Tstance=0.6, Tswing=0.4,initial_x = 0.0):
    ...
    def foot_trajectory_RL(self, t, fxyz, direction, leg_name, turn_radius,height,groud_clearance):
        self.zClearSwing = height
        self.zClearStance = groud_clearance
        x_t, z_t = self.curve_generator(t)
        x_r = x_t
        y_r = 0
        z_r = z_t
    ...
    def trot_generator_RL(self, t, direction, turn_radius,height,groud_clearance):
        self.zClearSwing = height
        self.zClearStance = groud_clearance
...
if __name__ == '__main__':
    ...
    while True:
        ...
        for i in range(100):
            ...
            height_nosie = np.random.uniform(-0.015,0.015)
            ground_clearance = np.random.uniform(-0.01,0.01)

            Txyz_FL = CPG_controller.foot_trajectory_RL(t, CPG_controller.leg_initalxyz, 'straight', 'FL', 0.8, 0.025+height_nosie, 0.01+ground_clearance)
