...
class Robot(Leg):
    def __init__(self, robot,pybullet_client,):
        ...
        self.motor_8angle = [0,0,0,0,0,0,0,0,0]
    ...
    def get_8motor_angle(self):
        self.motor_8angle[0:2] = self.motor_angle[1:3]
        self.motor_8angle[2:4] = self.motor_angle[4:6]
        self.motor_8angle[4:6] = self.motor_angle[7:9]
        self.motor_8angle[6:8] = self.motor_angle[10:12]
        return self.motor_8angle
    ...
    def get_observation(self):
        ...
        joints_angle =  self.get_8motor_angle()

        return np.hstack((rpy,angularXyz, joints_angle))
