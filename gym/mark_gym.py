...
class Spot_gym(gym.Env):
    ...
    def merge_action(self, action):
        ...
        LF[1:] = action[1:3] * self.opti_range
        RF[1:] = action[4:6] * self.opti_range
        LB[1:] = action[7:9] * self.opti_range
        RB[1:] = action[10:] * self.opti_range
